    ...
    run: async(client, message, args) => {
        ...
        collector.on('end', async (collected, reason) => {
            ...
            if(reason === "4") {
                ...
                return message.channel.send({content: `${client.custom_emojis.tick} • Welcomes have now been disabled!`})
            ...
            if(reason === "2") {
                ...
                return message.channel.send({content: `${client.custom_emojis.tick} • Welcome data has now been setup!`})
            }
        })
    }
}