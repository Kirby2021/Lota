...
module.exports = {
    ...
    description: "Remove a role to everyone in the server!",
    ...
    run: async(client, message, args) => {
        ...
        let finshed = 0
        let msg = await message.reply({content: `${client.custom_emojis.warning} • Removing roles from everyone, this may take a while! You will be pinged once finshed`})
      ...
      setTimeout(() => {
        msg.edit({content: `${client.custom_emojis.tick} • Finshed removing role ${role.name} to ${finshed} members!`})
