...
module.exports = async (interaction, client) => {
        ...
        .setDescription(` > ${client.custom_emojis.warning} • Please supply a members name/id/mention that you would like to unmute!`)
