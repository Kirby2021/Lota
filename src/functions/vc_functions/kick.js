...
module.exports = async (interaction, client) => {
        ...
        .setDescription(` > ${client.custom_emojis.warning} • Please supply a members name/id/mention that you would like to kick!`)
        ...
        collector.on("end", async (collected, reason) => {
            ...
            if(reason === "finshed"){
                ...
                .setDescription(` > ${client.custom_emojis.tick} • ${bannedMember} has been kicked from your vc!`)
                .setColor(client.colors.pink)
