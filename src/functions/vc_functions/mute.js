...
module.exports = async (interaction, client) => {
        ...
        .setDescription(` > ${client.custom_emojis.warning} • Please supply a members name/id/mention that you would like to mute!`)
        ...
        collector.on("end", async (collected, reason) => {
            ...
            if(reason === "finshed"){
                ...
                .setDescription(` > ${client.custom_emojis.tick} • ${bannedMember} has been muted from your vc!`)
                .setColor(client.colors.pink)
